...
data <- read_csv("JY23_Hypoxia.csv")

# Load the Seurat object containing spatial data
JY10 <- readRDS("rds_files/JY23_object.rds")
...
density_levels <- quantile(density_values, probs = seq(0.3, 0.7, by = 0.1))
...
# Save the plot
ggsave("JY23_improved_tumor_boundary.png", plot = boundary_plot, width = 8, height = 6)
...
# Save to a CSV file
write_csv(relabeled_barcodes, "JY23_relabeled_barcodes.csv")
